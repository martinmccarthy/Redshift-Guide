...
class GetReservedNodeExchangeConfigurationOptionsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.GetReservedNodeExchangeConfigurationOptionsInputMessageFilterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.GetReservedNodeExchangeConfigurationOptionsOutputMessageFilterSensitiveLog,
        };
